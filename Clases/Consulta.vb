...
Public Class Consulta
    ...
    Function SelToGridSingle(ByVal Consultas As String, ByVal Tablas As String)
        '******************************************************************
        '****************** CLAUSULA PARA SELECCIONAR *********************
        '******************************************************************
        Try
            ...
            conDB.OpenDB("SARE")
            con1 = conDB.conections("SARE")
            Dim query As String = "Select " & Consultas & " From " & Tablas

            con1.Command = New SqlCommand("Select " & Consultas & " From " & Tablas & "", con1.Connection)
          
            Dim resultado As String = con1.Command.ExecuteScalar()
            conDB.CloseDB()
            Return resultado
        Catch ex As Exception
            Throw
    ...
    Function SelToGridWhere(ByVal Consultas As String, ByVal Tablas As String, ByVal Condicion As String)
        ...
        Try
            ...
            Dim query As String = "Select " & Consultas & " From " & Tablas & " Where " & Condicion & ""
            con1.Adap = New SqlDataAdapter(con1.Command)
            Dim dts As New DataSet
            con1.Adap.Fill(dts)
            conDB.CloseDB()
    ...
    Function SelToGridWhereDis(ByVal Consultas As String, ByVal Tablas As String, ByVal Condicion As String)
        '******************************************************************
        '****************** CLAUSULA PARA SELECCIONAR *********************
        '******************************************************************
        Try
            ...
            con1.Command = New SqlCommand("Select Distinct " & Consultas & " From " & Tablas & " Where " & Condicion & "", con1.Connection)
            Dim query As String = "Select Distinct " & Consultas & " From " & Tablas & " Where " & Condicion & ""
            con1.Adap = New SqlDataAdapter(con1.Command)
            Dim dts As New DataSet
            con1.Adap.Fill(dts)
            conDB.CloseDB()
    ...
    Function SelToGridWhereSingle(ByVal Consultas As String, ByVal Tablas As String, ByVal Condicion As String)
        '******************************************************************
        '****************** CLAUSULA PARA SELECCIONAR *********************
        '******************************************************************
        Try
    ...
    Public Sub InsertarDatos(ByVal campos As String, ByVal valores As String, ByVal tabla As String)
        ...
        Try
            ...
            conDB.OpenDB("SARE")
            con1 = conDB.conections("SARE")
            Dim query1 As String = "Insert Into " & tabla & "(" & campos & ") values (" & valores & ")"
    ...
    Public Sub ActulizarGral(ByVal tabla As String, ByVal consulta As String, ByVal Condicion As String)
        ...
        Try
            ...
            Dim query As String = "Update " & tabla & " Set " & consulta & " Where " & Condicion
            con1.Command.ExecuteNonQuery()
            conDB.CloseDB()
        Catch ex As Exception
            Throw
